...
export class CriarEventosPostgresRepository implements AdicionarEventos {
  ...
  private criarEventoPeriodo1(
    ...
    if (entrada.isBefore(horarioEntradaEsperado1)) {
      ...
      console.log(
        `Evento criadooooooooooooo: ${eventoPeriodoReal.hora} - Tipo: ${eventoPeriodoReal.tipoId} - Minutos: ${eventoPeriodoReal.minutos}`,
      );
    } else {
      ...
      console.log(
        `Evento criadossssssssssssssss: ${eventoPeriodo1.hora} - Tipo: ${eventoPeriodo1.tipoId} - Minutos: ${eventoPeriodo1.minutos}`,
      );
    }
    ...
    if (qtdeLancamento === 1) {
      ...
      if (eventoSaidaAntecipada.minutos < 0) {
        ...
        console.log(`Evento de saída antecipada criado: Entrada - ${eventoSaidaAntecipada}, Saída - ${eventoSaidaAntecipada}`);
      }
    }
    ...
    if (excedeu) {
      console.log(
        `Evento criadouuuuuuuuuuuuuuu: ${eventoExcedentePositivo.hora} - Tipo: ${eventoExcedentePositivo.tipoId} - Minutos: ${eventoExcedentePositivo.minutos}`,
      );
  ...
  private criarEventoPeriodo2(
    ...
    if (saida.isBefore(horarioSaidaEsperado)) {
      ...
      console.log(
        `Evento criadoaaaaaaaaaaaaaa: ${eventoPeriodoReal.hora} - Tipo: ${eventoPeriodoReal.tipoId} - Minutos: ${eventoPeriodoReal.minutos}`,
      );
      ...
      if (excedeu) {
        console.log(
          `Evento criado000000000000: ${eventoExcedentePositivo.hora} - Tipo: ${eventoExcedentePositivo.tipoId} - Minutos: ${eventoExcedentePositivo.minutos}`,
        );
      } else if (eventoExcedentePositivo.minutos < 0 && !isFolga) {
      }
    } else {
      if (!temApenasUmPeriodo) {
        ...
        console.log(
          `Evento criadoiiiiiiiiiii: ${eventoPeriodoEsperado.hora} - Tipo: ${eventoPeriodoEsperado.tipoId} - Minutos: ${eventoPeriodoEsperado.minutos}`,
        );
      }
      ...
      if (!temApenasUmPeriodo) {
        ...
        if (excedeu) {
          console.log(
            `Evento excedente criado: ${eventoExcedentePositivo.hora} - Tipo: ${eventoExcedentePositivo.tipoId} - Minutos: ${eventoExcedentePositivo.minutos}`,
          );
        }
      }
      // Extrai a quantidade de lamçamentos feito no dia
      ...
      if (temApenasUmPeriodo && qtdeLancamento === 2) {
        ...
        eventos.push({ ...eventoPeriodoEsperado, ...{ periodoId: 2 } });
        console.log(
          `Evento criadoeeeeeeeeeeeeee: ${eventoPeriodoEsperado.hora} - Tipo: ${eventoPeriodoEsperado.tipoId} - Minutos: ${eventoPeriodoEsperado.minutos}`,
        );
      }
    }
